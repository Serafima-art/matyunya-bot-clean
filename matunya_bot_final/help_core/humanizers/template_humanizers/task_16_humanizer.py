...
IDEA_TEMPLATES: Dict[str, str] = {
    ...
    # --- 3.1 power_point ---
     "circum_to_in": (
        "В квадрате радиусы вписанной и описанной окружностей "
        "связаны между собой через диагональ квадрата.\n"
        "Радиус описанной окружности R всегда в <b>√2 раза больше</b> "
        "радиуса вписанной <b>r</b>.\n"
        "Запомни формулы:\n\n"
        "👉 <b>R = r · √2</b>\n"
        "👉 <b>r = R : √2</b>"
    ),
    ...
    "in_to_circum": (
        "В квадрате радиусы вписанной и описанной окружностей "
        "связаны между собой через диагональ квадрата.\n"
        "Радиус описанной окружности <b>R</b> всегда в <b>√2 раза больше</b> "
        "радиуса вписанной <b>r</b>.\n"
        "Запомни формулы:\n\n"
        "👉 <b>R = r · √2</b>\n"
        "👉 <b>r = R : √2</b>"
    ...
    "circum_to_side": (
        ...
        "Радиус описанной окружности <b>R</b> — \n"
        "это ровно <b>половина диагонали</b> квадрата.\n"
        "А сторона квадрата <b>a</b> связана с радиусом через √2.\n\n"
        "👉 <b>a = R · √2</b>"
    ),

    "circum_to_perimeter": (
        "Чтобы найти периметр квадрата, \n"
        "достаточно сначала найти длину его стороны,\n"
        "а затем умножить её на <b>4</b>."
    ),

    # --- 3.2 eq_triangle_circles ---
    ...
    "side_to_circum_diameter": (
        "В равностороннем треугольнике сторона и радиус описанной окружности \n"
        "связаны простой формулой.\n"
        "Если известна сторона, то радиус находится делением на √3,\n"
        "а диаметр — это просто удвоенный радиус.\n\n"
    ...
    "circum_radius_to_side": (
        "Связь между стороной равностороннего треугольника \n"
        "и радиусом описанной окружности очень простая:\n"
        "Сторона всегда больше радиуса в √3 раз."
    ),

    "side_to_circum_radius": (
        "Чтобы найти радиус описанной окружности по стороне, \n"
        "нужно сторону разделить на √3."
    ),

    "inradius_to_side": (
        "В равностороннем треугольнике радиус вписанной окружности \n"
        "связан со стороной формулой: r = a√3 / 6.\n"
        "Отсюда можно выразить сторону.\n"
        "❗ a = 6r / √3."
    ),
...
STEP_TEMPLATES: Dict[str, str] = {
    ...
    # ------------------------------------------------------------------
    # 3.1 square_incircle_circumcircle
    # ------------------------------------------------------------------
    ...
    # --- circum_to_in ---
    "STEP_SQ_RULE_CIRCUM_TO_IN": (
        "<b>Шаг 2.</b> Используем связь радиусов квадрата.\n"
        "➡️ <b>r = R : √2</b>"
    ),

    "STEP_SQ_CALC_DIV": (
        "<b>Шаг 3.</b> Выполним вычисление.\n"
        "➡️ <b>r = {given_val} : √2 = {answer}</b>"
    ),

    # --- in_to_circum ---
    "STEP_SQ_RULE_IN_TO_CIRCUM": (
        "<b>Шаг 2.</b> Используем связь радиусов квадрата.\n"
        "➡️ <b>R = r · √2</b>"
    ),
    ...
    # --- circum_to_side ---
    "STEP_SQ_RULE_CIRCUM_TO_SIDE": (
        "<b>Шаг 2.</b> Используем связь стороны и радиуса.\n"
        "➡️ <b>a = R · √2</b>"
    ),

    "STEP_SQ_SIDE_CALC": (
        "<b>Шаг 3.</b> Найдём сторону квадрата.\n"
        "➡️ <b>a = {given_val} · √2 = {side_val}</b>"
    ),

    # --- circum_to_perimeter ---
    "STEP_SQ_CIRCUM_TO_SIDE": (
        "<b>Шаг 2.</b> Найдём сторону квадрата по формуле \n"
        "<b>a = R · √2</b>\n\n"
        "➡️ <b>a = {given_val} · √2 = {side_val}</b>"
    ),

    "STEP_SQ_PERIMETER": (
        "<b>Шаг 3.</b> Найдём периметр.\n"
        "➡️ <b>P = 4 · a = 4 · {side_val} = {answer}</b>"
    ),
    ...
    "CIRCUM_DIAMETER_TO_RADIUS": (
        "<b>Шаг 2.</b> Найдем радиус описанной окружности.\n"
        "Радиус — это половина диаметра.\n"
        "➡️ <b>R = D : 2 = {diameter} : 2 = {radius}</b>"
    ),

    "RADIUS_TO_SIDE": (
        "<b>Шаг 3.</b> Найдем сторону треугольника.\n"
        "Сторона равностороннего треугольника связана  \n"
        "с радиусом описанной окружности формулой:\n"
        "➡️ <b>a = R · √3</b>\n\n"
        "Подставим значение R:\n"
        "➡️ <b>a = {radius} · √3 = {answer}</b>"
    ),
    ...
    "SIDE_TO_RADIUS": (
        ...
        "➡️ <b>R = a : √3</b>\n\n"
        "Подставим сторону:\n"
        "➡️ <b>R = {side} : √3 = {radius}</b>"
    ),

    "RADIUS_TO_DIAMETER": (
        "<b>Шаг 3.</b> Найдем диаметр.\n"
        "Диаметр в <b>2</b> раза больше радиуса:\n"
        "➡️ <b>D = 2 · R = 2 · {radius} = {answer}</b>"
    ),

    "DIRECT_RADIUS_TO_SIDE": (
    ...
    "DIRECT_SIDE_TO_RADIUS": (
        "<b>Шаг 2.</b> Используем формулу.\n"
        "➡️ <b>R = a : √3</b>\n\n"
        "<b>Шаг 3.</b> Вычислим ответ.\n"
        "➡️ <b>R = {side} : √3 = {answer}</b>"
    ),
...
TIPS_TEMPLATES: Dict[str, str] = {
    ...
    # ------------------------------------------------------------------
    "circum_to_in": (
        "Для квадрата важно помнить простое соотношение радиусов:\n\n"
        "🔹 радиус описанной окружности всегда больше радиуса вписанной\n"
        "🔹 они связаны формулой: <b>R = r · √2</b>\n\n"
        "Отсюда сразу следует:\n"
        "• если дан R → делим на √2\n"
        "• если дан r → умножаем на √2"
    ),
    ...
    "circum_to_side": (
        "Число √2 появляется не случайно.\n"
        "Квадрат можно разрезать диагональю \n"
        "на <b>два равных прямоугольных треугольника</b>.\n"
        "Катеты равны, гипотенуза = 2R.\n"
        "По теореме Пифагора: a² + a² = (2R)²\n"
        "Отсюда и получаем: <b>a = R · √2</b>."
    ),

    "circum_to_perimeter": (
        "Если знаешь сторону квадрата — задача почти решена.\n"
        "Периметр квадрата — это сумма <b>4 одинаковых сторон</b>."
    ),
    ...
    "side_to_circum_radius": (
        "В задачах ОГЭ сторона часто дается с \"хвостиком\" √3 \n"
        "именно для того, чтобы он красиво сократился при делении."
    ),
...
NARRATIVE_PROFILES: Dict[str, Dict[str, Any]] = {
    ...
    "circum_to_in": {
        "idea_key": "circum_to_in",
        "steps": [
            "STEP_SQ_GIVEN_FIND",
            "STEP_SQ_RULE_CIRCUM_TO_IN",
            "STEP_SQ_CALC_DIV",
        ],
        "tips_key": "circum_to_in",
        "required_fields": ["given", "target"],
    },

    "in_to_circum": {
        "idea_key": "in_to_circum",
        "steps": [
            "STEP_SQ_GIVEN_FIND",
            "STEP_SQ_RULE_IN_TO_CIRCUM",
            "STEP_SQ_CALC_MUL",
        ],
        "tips_key": "in_to_circum",
        "required_fields": ["given", "target"],
    },

    "circum_to_side": {
        "idea_key": "circum_to_side",
        "steps": [
            "STEP_SQ_GIVEN_FIND",
            "STEP_SQ_RULE_CIRCUM_TO_SIDE",
            "STEP_SQ_SIDE_CALC",
        ],
        "tips_key": "circum_to_side",
        "required_fields": ["given", "target"],
    },

    "circum_to_perimeter": {
        "idea_key": "circum_to_perimeter",
        "steps": [
            "STEP_SQ_GIVEN_FIND",
            "STEP_SQ_CIRCUM_TO_SIDE",
            "STEP_SQ_PERIMETER",
        ],
        "tips_key": "circum_to_perimeter",
        "required_fields": ["given", "target"],
    },
    ...
    "circum_diameter_to_side": {
        "idea_key": "circum_diameter_to_side",
        "steps": [
            "COMMON_GIVEN_TARGET",
            "CIRCUM_DIAMETER_TO_RADIUS",
            "RADIUS_TO_SIDE",
        ],
        "tips_key": "circum_diameter_to_side",
    },

    "side_to_circum_diameter": {
        "idea_key": "side_to_circum_diameter",
        "steps": [
            "COMMON_GIVEN_TARGET",
            "SIDE_TO_RADIUS",
            "RADIUS_TO_DIAMETER",
    ...
    "circum_radius_to_side": {
        "idea_key": "circum_radius_to_side",
        "steps": [
            "COMMON_GIVEN_TARGET",
            "DIRECT_RADIUS_TO_SIDE",
        ],
        "tips_key": "circum_radius_to_side",
    },

    "side_to_circum_radius": {
        "idea_key": "side_to_circum_radius",
        "steps": [
            "COMMON_GIVEN_TARGET",
            "DIRECT_SIDE_TO_RADIUS",
        ],
        "tips_key": "side_to_circum_radius",
    },

    "inradius_to_side": {
        "idea_key": "inradius_to_side",
        "steps": [
            "COMMON_GIVEN_TARGET",
            "INRADIUS_TO_SIDE",
        ],
        "tips_key": "inradius_to_side",
    },

    "side_to_inradius": {
        "idea_key": "side_to_inradius",
        "steps": [
            "COMMON_GIVEN_TARGET",
            "SIDE_TO_INRADIUS",
        ],
...
def _ctx_square_common(raw_vars: Dict[str, Any]) -> Dict[str, Any]:
    ctx = _base_context(raw_vars)

    given = raw_vars["given"]
    target = raw_vars["target"]

    given_symbol = given.get("symbol")
    given_val = given.get("value_str")
    target_symbol = target.get("symbol")
    target_val = target.get("value")

    ctx.update(
        given_text=f"{given_symbol} = {given_val}",
        target_text=target_symbol,
        given_val=given_val,          # ← ВОТ ОН
        answer=format_oge_number(raw_vars.get("answer")),
        side_val=target_val,
    )
...
def _ctx_circum_to_in(raw_vars: Dict[str, Any]) -> Dict[str, Any]:
    return _ctx_square_common(raw_vars)

def _ctx_in_to_circum(raw_vars: Dict[str, Any]) -> Dict[str, Any]:
    return _ctx_square_common(raw_vars)

def _ctx_circum_to_side(raw_vars: Dict[str, Any]) -> Dict[str, Any]:
    ctx = _ctx_square_common(raw_vars)

    ctx["side_val"] = raw_vars["target"]["value"]
    return ctx

def _ctx_circum_to_perimeter(raw_vars: Dict[str, Any]) -> Dict[str, Any]:
    ctx = _ctx_square_common(raw_vars)

    # Периметр — это и есть target
    ctx["side_val"] = raw_vars["target"]["value"] // 4
    return ctx

def _ctx_eq_triangle_circles(raw_vars: Dict[str, Any]) -> Dict[str, Any]:
    """
    Context-builder для паттерна eq_triangle_circles (Задание 16)

    Канон:
    - НЕ считаем
    - НЕ парсим
    - НЕ гадаем
    - Берём ТОЛЬКО строки из facts
    """

    ctx = _base_context(raw_vars)

    given = raw_vars.get("given", {})
    target = raw_vars.get("target", {})
    derived = raw_vars.get("derived", {}) or {}

    # -------------------------------------------------
    # Базовые тексты условия
    # -------------------------------------------------

    ctx.update(
        given_text=f'{given.get("symbol")} = {given.get("value_str")}',
        target_text=target.get("symbol"),
        answer=format_oge_number(raw_vars.get("answer")),
    )

    # -------------------------------------------------
    # Все возможные геометрические обозначения
    # (ТОЛЬКО строки!)
    # -------------------------------------------------
    ...
    # -------------------------------------------------
    # Заполнение из GIVEN (всегда value_str)
    # -------------------------------------------------

    g_type = given.get("element_type")
    g_val = given.get("value_str")

    if g_type == "side":
        ctx["a"] = g_val
        ctx["side"] = g_val

    elif g_type == "circumcircle_radius":
        ctx["R"] = g_val
        ctx["radius"] = g_val

    elif g_type == "circumcircle_diameter":
        ctx["D"] = g_val
        ctx["diameter"] = g_val

    elif g_type == "incircle_radius":
        ctx["r"] = g_val

    # -------------------------------------------------
    # Заполнение из DERIVED (промежуточные величины)
    # Например: R при circum_diameter_to_side
    # -------------------------------------------------

    for item in derived.values():
        et = item.get("element_type")
        val = item.get("value_str")

        if et == "side":
            ctx["a"] = val
            ctx["side"] = val

        elif et == "circumcircle_radius":
            ctx["R"] = val
            ctx["radius"] = val

        elif et == "circumcircle_diameter":
            ctx["D"] = val
            ctx["diameter"] = val

        elif et == "incircle_radius":
            ctx["r"] = val

    # -------------------------------------------------
    # Заполнение из TARGET (value_str уже гарантирован solver’ом)
    # -------------------------------------------------

    t_type = target.get("element_type")
    t_val = target.get("value_str")

    if t_type == "side":
        ctx["a"] = t_val
        ctx["side"] = t_val

    elif t_type == "circumcircle_radius":
        ctx["R"] = t_val
        ctx["radius"] = t_val

    elif t_type == "circumcircle_diameter":
        ctx["D"] = t_val
        ctx["diameter"] = t_val

    elif t_type == "incircle_radius":
        ctx["r"] = t_val
...
_CONTEXT_BUILDERS: Dict[str, Callable[[Dict[str, Any]], Dict[str, Any]]] = {
    ...
    "circum_to_in": _ctx_circum_to_in,
    "in_to_circum": _ctx_in_to_circum,
    "circum_to_perimeter": _ctx_circum_to_perimeter,
    "circum_to_side": _ctx_circum_to_side,

    "circum_diameter_to_side": _ctx_eq_triangle_circles,
    "side_to_circum_diameter": _ctx_eq_triangle_circles,
    "circum_radius_to_side": _ctx_eq_triangle_circles,
