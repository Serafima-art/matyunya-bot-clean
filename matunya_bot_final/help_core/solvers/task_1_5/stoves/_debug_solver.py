# matunya_bot_final/help_core/solvers/task_1_5/stoves/_debug_solver.py
...
from matunya_bot_final.help_core.solvers.task_1_5.stoves.stoves_solver import solve_stoves
...
OUTPUT_FILE = Path(__file__).parent / "debug_solver_1_5_stoves_output.txt"
