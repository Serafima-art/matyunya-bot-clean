...
ИСПРАВЛЕННАЯ ВЕРСИЯ - поддержка всех 16 паттернов
"""
...
class AllPatternsGenerator:
    ...
    def _generate_task_text(self, subtype: str, data: Dict[str, Any]) -> str:
        ...
        templates = {
            ...
            "triangle_by_two_angles_and_side": f"В треугольнике известны углы {data['angle1']}° и {data['angle2']}°, а также сторона = {data['known_side']}. Найдите пропорциональную сторону."
        }
